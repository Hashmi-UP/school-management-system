                ...
                <div class="row">
                  <div class="col-md-12">
                    <div class="date-picker">
                      ...
                      <form class="theme-form"  method="POST" action="/editstudentdb" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="mb-3 row g-3">
                            ...
                            <div class="col-xl-5 col-sm-9">
                              <div class="input-group">
                                <input class="form-control" name="studentname" id="studentname" type="text" placeholder="" data-bs-original-title="" title="" value="{{$data1->name}}">
