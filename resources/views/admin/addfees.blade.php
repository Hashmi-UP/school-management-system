                ...
                <div class="row">
                  <div class="col-md-12">
                    <div class="date-picker">
                      ...
                      <form class="theme-form"  method="POST" action="/addfeesdb" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="mb-3 row g-3">
                            ...
                            <div class="col-xl-5 col-sm-9">
                              <div class="input-group">
                                <input class="form-control" name="tutionfees" id="tutionfees" type="integer" placeholder="" data-bs-original-title="" title="">
                        ...
                        <div class="mb-3 row g-3">
                            ...
                            <div class="col-xl-5 col-sm-9">
                              <div class="input-group">
                                <input class="touchspin form-control" name="fine" id="fine" type="integer" value="0" style="display: block;" data-bs-original-title="" title="">
