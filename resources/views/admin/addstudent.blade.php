                ...
                <div class="row">
                  <div class="col-md-12">
                    <div class="date-picker">
                      ...
                      <form class="theme-form"  method="POST" action="/addstudentdb" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="mb-3 row g-3">
                            ...
                            <div class="col-xl-5 col-sm-9">
                              <div class="input-group">
                                <input class="form-control" name="studentname" id="name" type="text" placeholder="" data-bs-original-title="" title="" >
                        ...
                        <div class="mb-3 row g-3">
                            <label class="col-sm-3 col-form-label text-sm-end">Father Name</label>
                            <div class="col-xl-5 col-sm-9">
                              <div class="input-group">
                                <input class="form-control" name="fathername" id="lastname" type="text" placeholder="" data-bs-original-title="" title="">
                        ...
                        <div class="mb-3 row g-3">
                            <label class="col-sm-3 col-form-label text-sm-end">Date of Birth</label>
                            <div class="col-xl-5 col-sm-9">
                              <div class="form-row">
                                  <div class="col-md-12 mb-2">
                                      <input class="datepicker-here form-control digits" name="dob" type="text" data-language="en" data-multiple-dates-separator=", " data-position="top right" placeholder="top right">
